...
var data1 = document.getElementById('data4');
var data1 = document.getElementById('data5');
var data1 = document.getElementById('data6');
var data1 = document.getElementById('data7');
var data1 = document.getElementById('data8');
var data1 = document.getElementById('data9');
var data1 = document.getElementById('data10');
var data1 = document.getElementById('data11');
var data1 = document.getElementById('data12');
var data1 = document.getElementById('data13');
var data1 = document.getElementById('data14');
var data1 = document.getElementById('data15');
...
var data1text = document.getElementById('data4text');
var data1text = document.getElementById('data5text');
var data1text = document.getElementById('data6text');
var data1text = document.getElementById('data7text');
var data1text = document.getElementById('data8text');
var data1text = document.getElementById('data9text');
var data1text = document.getElementById('data10text');
var data1text = document.getElementById('data11text');
var data1text = document.getElementById('data12text');
var data1text = document.getElementById('data13text');
var data1text = document.getElementById('data14text');
var data1text = document.getElementById('data15text');
